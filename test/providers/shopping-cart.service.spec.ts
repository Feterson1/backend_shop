...
describe('BoilerParts Controller',() => {
    ...
    it('Should return updated count cart item',async () => {
        const result = await shoppingCartService.updateCount(2,1);

            expect(result).toEqual({count: 2});
    });

    it('Should return updated total price cart item',async () => {
        const part = await boilerPartsService.findOne(1);
    ...
    it('Should deleted cart item',async () => {
    ...
    it('Should deleted all cart items',async () => {
